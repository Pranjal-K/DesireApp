...
public class internPage extends AppCompatActivity {
    ...
    EditText countfield, billfield, soldbyfield;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intern_page);
        ...
        adminScreen = findViewById(R.id.adminPage);
        ...
        adminScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent admin = new Intent(internPage.this, passcode.class);
                startActivity(admin);
            }
        });
        ...
        mFirebaseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(fnm)) {
                    loadingBar.dismiss();
                    Toast.makeText(internPage.this, "Please provide your credentials", Toast.LENGTH_SHORT).show();
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(internPage.this, "Please provide your credentials", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(tbill)) {
                    loadingBar.dismiss();
                    Toast.makeText(internPage.this, "Please provide your credentials", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(soldby)) {
                    loadingBar.dismiss();
                    Toast.makeText(internPage.this, "Please provide your credentials", Toast.LENGTH_SHORT).show();
                } else {
                    mDatabase.push().setValue(dataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                loadingBar.dismiss();
                                Toast.makeText(internPage.this, "Form Submitted", Toast.LENGTH_LONG).show();
                            } else {
                                loadingBar.dismiss();
                                Toast.makeText(internPage.this, "Error...", Toast.LENGTH_LONG).show();
                            }
                            Intent intent = new Intent(internPage.this, internPage.class);
